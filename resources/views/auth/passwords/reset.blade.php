...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="text-xl font-bold text-center bg-gray-800 card-header text-slate-50">{{ __('Reset Password') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control hover:shadow-xl hover:shadow-gray-500 form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control hover:shadow-xl hover:shadow-gray-500 form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
